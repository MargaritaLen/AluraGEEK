...
function mensagemErroEmail() {
    ...
    mensagemEmail.innerHTML += `Correo Invalido`
}
...
function mensagemErroSenha() {
    ...
    mensagemSenha.innerHTML += `La constraseña debe contener al menos 6 digitos, por lo menos una letra mayúscula, por lo menos una letra minúscula y un carácter especial`
}
